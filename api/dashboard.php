...
$(function(){
    ...
    window.loadPage=function(page){
        ...
        $.ajax({
            url:'/api/proses/ajax_handler.php', type:'POST', dataType:'html', timeout:20000,
    ...
    window.openModal=function(type,id){
        $.ajax({ url:'/api/proses/ajax_handler.php', type:'POST', dataType:'html', timeout:15000,
    ...
    window.deleteData=function(type,id){
        $.post('/api/proses/ajax_handler.php',{action:'delete',type:type,id:id},function(res){

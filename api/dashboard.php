    ...
    <div id="sidebar" class="fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out w-72 bg-dark text-white shadow-2xl z-50 flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4 space-y-6">
            ...
            <ul class="space-y-1" id="navMenu">
                ...
                <?php endif; ?>
                <li class="nav-item" data-page="peta"><a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all hover:bg-white/10 font-medium text-sm text-emerald-100 hover:text-white"><i class="fas fa-map-location-dot w-5"></i> Peta Live</a></li>
                <li class="nav-item" data-page="marketplace"><a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all hover:bg-white/10 font-medium text-sm text-emerald-100 hover:text-white"><i class="fas fa-store w-5"></i> Pasar Pupuk</a></li>
                <li class="nav-item" data-page="chat"><a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all hover:bg-white/10 font-medium text-sm text-emerald-100 hover:text-white"><i class="fas fa-comments w-5"></i> Chat Petani</a></li>
                <li class="nav-item" data-page="notifikasi"><a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all hover:bg-white/10 font-medium text-sm text-emerald-100 hover:text-white"><i class="fas fa-bell w-5"></i> Notifikasi <span class="ml-auto bg-red-500 text-white text-[9px] font-black px-1.5 py-0.5 rounded-full">3</span></a></li>
